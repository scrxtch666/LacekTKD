...
const [showRegisterModal, setShowRegisterModal] = useState(null); // examId
...
const handleAdminRegisterFighter = async () => {
                      ...
                      >
                        ...
                        {(userRole === "admin" || userRole === "trainer") && (
                          ...
                          >
                           ...
                           <button
      onClick={() => { setShowRegisterModal(exam.id); setSelectedFighter(""); }}
  ...
  <div className="fixed inset-0 bg-black/50 z-[9999] flex items-center justify-center p-4"
    ...
    <div className="bg-white rounded-2xl shadow-xl p-6 w-full max-w-sm space-y-4"
      ...
      <div className="flex justify-between items-center">
        <h3 className="font-semibold text-gray-800">Přihlásit závodníka na zkoušku</h3>
        <button onClick={() => setShowRegisterModal(null)} className="text-gray-400 hover:text-gray-600">
          <X size={20} />
        </button>
      </div>
      ...
      <div className="flex gap-2">
        <button onClick={handleAdminRegisterFighter} disabled={registerLoading}
        ...
        <button onClick={() => setShowRegisterModal(null)}
