...
--
-- Počítač: 127.0.0.1
-- Vytvořeno: Pon 06. dub 2026, 11:45
...
(9, 'Test', 'awd', 10, 'Availible', '2026-04-05 19:30:32', '2026-05-06 22:00:00', NULL);
...
(2, 'Matěj', 'Kaman', '2025-02-20 12:02:57', 7, '/src/assets/Fighters/kaman_matej.jpg', 1, 1, 1, 4, 83),
(3, 'Adéla', 'Pejcalová', '2026-04-13 22:00:00', 6, '/src/assets/Fighters/pejcalova_adela.jpg  ', 1, 0, 1, 4, 12),
...
(14, 'Tereza', 'Urbánková', '2026-04-07 22:00:00', 5, '/src/assets/Fighters/urbankova_tereza.jpg  ', 0, 1, 1, 3, 73),
...
(17, 'Zuzana', 'Válková', '2026-04-04 14:20:16', 5, '/src/assets/Fighters/valkova_zuzana.jpg  ', 1, 0, 1, 1, 0),
...
(24, 'Petr', 'Svoboda', '2026-04-03 22:00:00', 4, NULL, 0, 0, 1, NULL, 90);
...
(29, '3 turnaj na 12.3', 'Humpolec', 123, 1, '2026-03-12', NULL, 'Tets 3 turnaje', '/uploads/tournaments/tournament-1774537625038-562906494.png', NULL, '2026-03-10', '96ug79l3747bbu2icfe0lqo5po', 'completed');
...
(10, 'admin', '$2b$10$2q.P/HApqlMkttjF2G.zmu7vmGw/7jdrZUKI2Igwlx2bwqfLOTfPS', 'admin123@seznam.cz', '725 562 561', 22, 1, 'approved'),
...
(24, 'uzivatel1', '$2b$10$UZ7Nn/GCOKzNYFTa5KNbFeZskyhhdQg/5J12M2qz2eRalanppNbei', 'uzivatel1@seznam.cz', '734 562 346', 16, 3, 'approved'),
(26, 'testZadosti', '$2b$10$4BlJ9sY/AXcvAL7wqq7teOD9nksULNG3DyJh.aCWFJzdmPsRN9we.', 'tetszadosti@seznam.cz', NULL, 11, 3, 'pending'),
(27, 'pejcalka', '$2b$10$UDKoo9XnqehAxn1uFzlOaOuOhwXInojy84LrKots2oHnBLgKKE52W', 'pejcalka@seznam.cz', '', 3, 3, 'approved'),
(28, 'test', '$2b$10$49VmBM4mvnWRqdRSgXiGKeeJPaGxH7UC73/g8efdnqIcdb3O6EtUW', 'test@seznamTest.cz', '', 17, 3, 'approved'),
(29, 'petr', '$2b$10$7Cs2bjB6oyZCL4LZmThWV.08qPnQpjCigXepq8g3HqOAhqvq3MC7O', 'taefax@seznam.cz', '721 642 737', 24, 3, 'approved'),
(30, 'testGDPR', '$2b$10$DC./LNzTTn6iUpKt3w.8wOo72/ihqpNO382Jah2bvO8guaGLiqQgG', 'testGDPR@seznam.cz', NULL, NULL, 3, 'pending'),
(31, 'test2', '$2b$10$nmfk2ubEHiO6wETse9/fHu6Estc81EWEDGBmIWUWe0lW/ATR1TuN2', 'test2@seznam.cz', NULL, NULL, 3, 'pending');
