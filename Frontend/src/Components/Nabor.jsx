...
function Nabor() {
  return (
    <>
      <button
        type="button"
        className=" w-full hidden xl:flex relative items-center justify-evenly text-customGreen bg-customWhite rounded-lg text-sm text-center dark:bg-customWhite space-x-6 w-200px border border-customGreen"
      >
        {/* Tlačítko bude skryté na menších obrazovkách (do 1024px) a viditelné na větších */}
        <Link to="/register" className="items-center justify-between">
          ...
          <div className="flex justify-center align-middle text-xs w-32 h-8 items-center font-semibold">
            NÁBOR OTEVŘEN
          </div>
        </Link>
      </button>
